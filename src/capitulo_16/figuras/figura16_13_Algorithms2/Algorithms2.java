package capitulo_16.figuras.figura16_13_Algorithms2;
...
public class Algorithms2 {
	...
	public static void main(String[] args) {
		...
		List<String> list1 = new ArrayList<String>(Arrays.asList(colors));
		ArrayList<String> list2 = new ArrayList<>();

		list2.add("black"); // adiciona "black" ao final da list1
